...
public class Main {
    ...
    public static List<String> extractEmails(String str) {
        ...
        // one or more chars before '@', and correct domain; word boundaries to avoid trailing punctuation
    ...
    public static boolean checkForDoubles(String str) {
        ...
        // some capital letter [A-Z] appears at least twice anywhere in the string
